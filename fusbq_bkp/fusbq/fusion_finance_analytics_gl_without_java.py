...
dag = models.DAG(
    f"fusion_finance_analytics_gl_without_java",
...
def create_dynamic_tasks():
    ...
    for a in output_dict:
        ...
        PRE_BATCH_STEP.set_downstream(stg_table_load)
...
STG_COMPLETION_CHECK >> POST_BATCH_FAIL_STEP
STG_COMPLETION_CHECK >> POST_BATCH_STEP
